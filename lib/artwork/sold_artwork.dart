...
class SoldArtwork extends StatefulWidget {
  SoldArtwork({Key key}) : super(key: key);

  @override
  _SoldArtworkState createState() => _SoldArtworkState();
}

class _SoldArtworkState extends State<SoldArtwork> {
